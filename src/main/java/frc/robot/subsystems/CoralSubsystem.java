...
/**
 * This roller implementation is for a Talon FX driving a motor like the Falon
 * 500 or Kraken X60.
 */
public class CoralSubsystem extends SubsystemBase {
  ...
  /**
   * Shoots the coral out. Coral mechanism will continue to spin while being
   * called. Defaults to not moving.
   */
